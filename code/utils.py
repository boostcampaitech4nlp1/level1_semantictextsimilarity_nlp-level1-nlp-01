...
# This codes were forked from https://github.com/archinetai/smart-pytorch/blob/main/smart_pytorch/smart_pytorch.py
# We just added random seed fixing function to original code and changed loss function. 
