...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='tunib/electra-ko-en-base', type=str)
    parser.add_argument('--batch_size', default=8, type=int)
    parser.add_argument('--max_epoch', default=30, type=int)
    parser.add_argument('--shuffle', default=True)
    parser.add_argument('--learning_rate', default=1e-5, type=float)
    parser.add_argument('--train_path', default='../data/train_sez_preprocessed.csv')
    parser.add_argument('--dev_path', default='../data/dev_preprocessed.csv')
    parser.add_argument('--test_path', default='../data/dev_preprocessed.csv')
    parser.add_argument('--predict_path', default='../data/test_preprocessed.csv')
